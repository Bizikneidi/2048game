...
public class GameServlet extends HttpServlet {
    ...
    private String game2Html(UUID id, Game game) {
        ...
        sb.append("                            <div class=\"col mt-1 ml-1 mr-1 bg-light\">" + game.getValueAt(3, 0) + "</div>\n");
        sb.append("                        </div>\n");
        sb.append("                        <div class=\"row\">\n");
        ...
        sb.append("                            <div class=\"col mt-1 ml-1 mr-1 bg-light\">" + game.getValueAt(3, 1) + "</div>\n");
        sb.append("                        </div>\n");
        sb.append("                        <div class=\"row\">\n");
        ...
        sb.append("                            <div class=\"col mt-1 ml-1 mr-1 bg-light\">" + game.getValueAt(3, 2) + "</div>\n");
        sb.append("                        </div>\n");
        sb.append("                        <div class=\"row\">\n");
        sb.append("                            <div class=\"col mt-1 ml-1 mb-1 bg-light\">" + game.getValueAt(0, 3) + "</div>\n");
        sb.append("                            <div class=\"col mt-1 ml-1 mb-1 bg-light\">" + game.getValueAt(1, 3) + "</div>\n");
        sb.append("                            <div class=\"col mt-1 ml-1 mb-1 bg-light\">" + game.getValueAt(2, 3) + "</div>\n");
